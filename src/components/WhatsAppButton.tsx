...
export default function WhatsAppButton({ modelName }: WhatsAppButtonProps) {
  ...
  return (
    <div className="fixed bottom-20 right-4 md:bottom-24 md:right-6 z-[110] flex items-center justify-center">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-[0_0_20px_rgba(37,211,102,0.5)] hover:scale-110 hover:shadow-[0_0_30px_rgba(37,211,102,0.8)] transition-all duration-300 group"
